...
def run():
    ...
    print("""
    Detecting echoes with more realistic flare profiles is much harder than delta-functions, even under good conditions.
    Again, we create a delta-function active star (zero radius), give it really clear flares,
