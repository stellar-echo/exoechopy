...
w_2 = 0*u.deg
m0_2 = 0*u.deg
name_2 = "e: "+str(e_2)+", a: "+u_str(a_2)+", i: "+u_str(i_2)+", Ω: "+u_str(L_2)+", ω: "+u_str(w_2)+", M0: "+u_str(m0_2)
...
w_3 = 90*u.deg
m0_3 = 0*u.deg
name_3 = "e: "+str(e_3)+", a: "+u_str(a_3)+", i: "+u_str(i_3)+", Ω: "+u_str(L_3)+", ω: "+u_str(w_3)+", M0: "+u_str(m0_3)
...
w_4 = 90*u.deg
m0_4 = 0*u.deg
name_4 = "e: "+str(e_4)+", a: "+u_str(a_4)+", i: "+u_str(i_4)+", Ω: "+u_str(L_4)+", ω: "+u_str(w_4)+", M0: "+u_str(m0_4)
...
w_5 = 90*u.deg
m0_5 = 120*u.deg
name_5 = "e: "+str(e_5)+", a: "+u_str(a_5)+", i: "+u_str(i_5)+", Ω: "+u_str(L_5)+", ω: "+u_str(w_5)+", M0: "+u_str(m0_5)
