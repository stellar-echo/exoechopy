...
if __name__ == '__main__':
    flare_onset = u.Quantity(5, 's')
    flare_decay = u.Quantity(15, 's')
    my_flare = ParabolicRiseExponentialDecay(onset=flare_onset, decay=flare_decay)

    all_times = u.Quantity(np.linspace(-10, 100, 200), 's')

    print("This demonstrates the PRED flare (Parabolic Rise Exponential Decay) capabilities of ExoEchoPy")
    print("These functions are from the file: exoechopy > simulate > flares > flares.py")
    print("To use these in eep, use eep.simulate.ParabolicRiseExponentialDecay()")
    print("The flare will begin at 0 seconds")
