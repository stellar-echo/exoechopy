...
class ActiveRegion:
    ...
    def __init__(self,
        ...
        The distributions are expected to be numpy.random or scipy.stats distributions, but it's not currently required.
        Use other distributions at your own risk.

        :param DeltaFlare flare_type: Class for generating flare shapes
